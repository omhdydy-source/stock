    ...
    try:
        ...
        for ctx in browser.contexts:
            for page in ctx.pages:
                if "79264" in page.url or "리버스모드" in page.title():
                    ...
                    print("--- POST 79264 CONTENT START ---")
                    print(content[:3000])
                    print("--- POST 79264 CONTENT END ---")
                    
                    with open("C:/Users/omh/Desktop/stock/cafe_post_79264.txt", "w", encoding="utf-8") as f:
                        f.write(content)
                    break
